...
import LandingAnimation from "./components/animation";
import Footer from "components/footer/footer";
import styles from "./landing.module.css";
import { motion } from "framer-motion";
const Landing = () => {
  return (
    <div className={styles.welcomeWrapper} data-testid="welcome-page">
      <main className={styles.mainContent}>
        ...
        <section className={styles.aboutSection} data-testid="about-section">
          <Container>
